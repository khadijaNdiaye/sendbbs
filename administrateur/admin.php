        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown notifications-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-warning">nombres de notifications</span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">Nouvelle notifications</li>
            </ul>
          </li>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?=$_SESSION['AUTHENTIFICATION']['login']?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?=$_SESSION['AUTHENTIFICATION']['login']?></p>
          <a href="#"><i class="fa fa-circle text-success"></i> connceté</a>
        </div>
      </div>
      <!-- search form -->
          ...
          <ul class="treeview-menu">
			<li class="active treeview">
				<ul class="nav nav-list">
					<li class="active"><a href="pages/forms/general.php">ARTICLES</a></li>
					<li><a href="#">CATEGORIES</a></li>
					<li><a href="#">MARQUES</a></li>
					<li><a href="#">BOUTIQUES</a></li>
					<li><a href="./pages/forms/privilege.html">PRIVILEGES</a></li>
				</ul>
			</li>
		</li>
          </ul>
